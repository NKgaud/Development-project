...
function Profile() {
    ...
    const fetch = async () => {
        const res = await axios.get(`http://localhost:3000/customer/${localStorage.getItem('customer_id')}`);
                ...
                <div className="container py-xl-5 py-lg-3">
                    ...
                    <div className="row pt-md-4">
                        <div className="col-lg-6 about_right">
                            <h3 className="text-capitalize text-right font-weight-light font-italic">ID : {data.id} <br />
